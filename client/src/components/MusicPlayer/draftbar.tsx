...
export default function PlayerBar({
  ...
  return (
    <div className="p-3 md:p-4 gap-5 w-full  bg-bg2 h-23 rounded-xl flex flex-col items-center justify-center">
      {/* Artwork / vinyl */}
      ...
      <div className="relative w-16 h-16 shadow-2xl">
        ...
        {/* Vinyl */}
        <div
          className={`absolute -right-25 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full ${
      ...
      <div
        className={`truncate flex flex-col justify-center items-center ${
          nowPlaying ? "text-xl" : "text-3xl"
        } font-medium`}
      >
