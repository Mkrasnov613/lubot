...
- 5d01110: Fix login bouncing back to the home page in production.
...
- 9696aae: Renovate app's design
- a878876: Migrate the database from local SQLite to Neon (serverless Postgres)
...
- 0672eec: Fix webpack serialization
- dc8aef7: Delete deprecated and broken components from /bot and /music pages
...
- 08fbcf9: Improve projects' directories structure
